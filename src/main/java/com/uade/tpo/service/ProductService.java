...
public interface ProductService {
    ...
    public Product createProduct(ProductRequest productRequest, String username) throws ProductDuplicateException, CategoryNotFoundException, ProductNotFoundException; //Crea un nuevo producto
